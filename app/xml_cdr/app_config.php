<?php
	...
	//default settings
		...
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "e8f73acf-1bb5-4021-b978-31153c9596a3";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "cdr";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "recording_download_friendly_name";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "boolean";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Rename recording downloads from CDR page by date_source_destination";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "9c1c75e3-76c4-4b6c-bb40-e3f11b0971ec";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "cdr";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "recording_download_name_date_format";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "YYYY-MM-DD_HHMISS";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Format for recording name prefix during download. Uses Postgresql date/time templates https://www.postgresql.org/docs/current/functions-formatting.html";
		$y++;
